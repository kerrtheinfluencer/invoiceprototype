  ...
  const ACCESS_KEY = 'sellerTrackerAccessEmail';
  ...
  function renderOrders() {
    ...
    orders.forEach((order, index) => {
      ...
      div.innerHTML = `
        ...
        <div class="btn-group">
          <button onclick="generatePDF(${index})" class="download-btn">Download PDF</button>
  ...
  async function submitAccessEmail(email) {
  ...
  function initializeAccessGate() {
    ...
    form.addEventListener('submit', async (event) => {
      ...
      feedback.textContent = 'Saving your access...';
      try {
        await submitAccessEmail(email);
